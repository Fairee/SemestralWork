...
// TAKEN FROM an opensource project created by google to show how geospatial api works
...
[System.Flags] public enum ErrorState { Null = 0, NoError = 1, Tracking = 2, Message = 4, Camera = 8, Location = 16 }
    ...
    /// Best horizontal accuracy value reached at any point during the current session
    /// </summary>
    public double WantedHorizontalAccuracy { get => _minimumHorizontalAccuracy; }

    /// <summary>
    /// Best heading accuracy value reached at any point during the current session
    /// </summary>
    public double WantedHeadingAccuracy { get => _minimumHeadingAccuracy; }

    /// <summary>
    /// Best altitude accuracy value reached at any point during the current session
    /// </summary>
    public double WantedVerticalAccuracy { get => _minimumVerticalAccuracy; }
    ...
    public ErrorState CurrentErrorState { get => _errorState; }
        ...
        [Header("[ Settings ]")]
        [SerializeField] private float _initTime = 5f;
        ...
        private void Update()
        {
            ...
            {
                SetErrorState(ErrorState.Message, "Error: Unable to start Geospatial AR" + earthState);
                //enabled = false;
                return;
            }
